...
item_file <- paste(basedir,"pattern/ROI_based/ref_space/me/rt_mem_RaPHG.txt",sep="/")
item_data <- read.table(item_file,header=FALSE)
act_file <- paste(basedir,"pattern/ROI_based/ref_space/me/act_RaPHG.txt",sep="/")
...
subhip_file <- paste(basedir,"pattern/ROI_based/ref_space/me/act_subiculum.txt",sep="/")
...
write.matrix(r.itemInfo,file="itemInfso_RaPHG_subiculum.txt",sep="\t")
