...
item_file <- paste(basedir,"pattern/ROI_based/ref_space/me/rt_mem_RSMG.txt",sep="/")
item_data <- read.table(item_file,header=FALSE)
act_file <- paste(basedir,"pattern/ROI_based/ref_space/me/act_RSMG.txt",sep="/")
...
write.matrix(r.itemInfo,file="itemInfso_RSMG_subiculum.txt",sep="\t")
