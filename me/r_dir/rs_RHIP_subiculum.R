...
item_file <- paste(basedir,"pattern/ROI_based/ref_space/me/rs_mem_RHIP.txt",sep="/")
item_data <- read.table(item_file,header=FALSE)
act_file <- paste(basedir,"pattern/ROI_based/ref_space/me/act_RHIP.txt",sep="/")
...
write.matrix(r.itemInfo,file="itemInfso_RHIP_subiculum.txt",sep="\t")
