...
item_file <- paste(basedir,"pattern/ROI_based/ref_space/me/rt_mem_RVVC.txt",sep="/")
item_data <- read.table(item_file,header=FALSE)
act_file <- paste(basedir,"pattern/ROI_based/ref_space/me/act_RVVC.txt",sep="/")
...
write.matrix(r.itemInfo,file="itemInfso_RVVC_subiculum.txt",sep="\t")
