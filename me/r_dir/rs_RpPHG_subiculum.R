...
item_file <- paste(basedir,"pattern/ROI_based/ref_space/me/rs_mem_RpPHG.txt",sep="/")
item_data <- read.table(item_file,header=FALSE)
act_file <- paste(basedir,"pattern/ROI_based/ref_space/me/act_RpPHG.txt",sep="/")
...
write.matrix(r.itemInfo,file="itemInfso_RpPHG_subiculum.txt",sep="\t")
