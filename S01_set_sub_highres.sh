  ...
  #      		then
   #         			cp $f ${filedmapdir}/fieldmap_phase.nii.gz
    ...
    #			done
		...
		#fsl_prepare_fieldmap SIEMENS ${fieldmapdir}/fieldmap_phase ${fieldmapdir}/fieldmap_mag_brain ${fieldmapdir}/fieldmap_rads 2.46
        ...
        #fsl_sub bet ${anatomydir}/highres.nii.gz ${anatomydir}/highres_brain.nii.gz -f 0.25 -R
        bet ${anatomydir}/highres.nii.gz ${anatomydir}/highres_brain.nii.gz -m  -f 0.2 -R -B
		# generate a tight mask for fieldmap use
		#fsl_sub bet ${anatomydir}/highres.nii.gz ${anatomydir}/3d_brain_tight.nii.gz -m -f 0.4 -R -B
        #fslmaths ${anatomydir}/highres_brain.nii.gz -ero ${anatomydir}/3d_brain_tight.nii.gz
        #	fi
done
